...
function pages() {
  return gulp.src('frontend/src/pages/**/*.{html,hbs,handlebars}')
    .pipe(panini({
      root: 'frontend/src/pages/',
      layouts: 'frontend/src/layouts/',
      partials: 'frontend/src/partials/',
...
function styleGuide(done) {
  sherpa('frontend/src/styleguide/index.md', {
    output: PATHS.dist + '/styleguide.html',
    template: 'frontend/src/styleguide/template.html'
  }, done);
}
...
function watch() {
  ...
  gulp.watch('frontend/src/styleguide/**', gulp.series(styleGuide, browser.reload));
}
